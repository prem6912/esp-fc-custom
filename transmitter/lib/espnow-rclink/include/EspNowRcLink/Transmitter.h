...
public:
  ...
  const uint8_t* getPeer() const { return _peer; }
  State getState() const { return _state; }
  bool isConnected() const { return _state == TRANSMITTING; }
  uint32_t getLastRecvTime() const { return _last_recv_time; }
