...
static const size_t LINK_ALIVE_INTERVAL_MS = 200; // Increased frequency to 5Hz for responsive telemetry
...
/*
  ...
  - payload: variable length [0-248] - message payload (optional)
